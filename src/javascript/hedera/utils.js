...
//Convert hex Account address to AccountID 
const hexToAccountID = hexString => {
    const value = hexToDecimal(hexString);
    return `0.0.${value}`;
}

export { enumKeyByValue, friendlyHederaResponseCodeEnum, hexStringToUint8Array, hexToDecimal, hexToAccountID }
